...
async function getFromPostgres(req,res) {
    try {
        ...
        return res.json ({ code : 501, success: true, message: "Ooopsss!, Something is wrong", data: error })
    }
}
...
async function createTable(req,res) {
    try {
        ...
        return res.json ({ code : 502, success: true, message: "Ooopsss!, Something is wrong", data: error })
    }
...
async function dropTable(req,res){
    try {
        ...
        return res.json ({ code : 503, success: true, message: "Ooopsss!, Something is wrong", data: error })
    }
}
